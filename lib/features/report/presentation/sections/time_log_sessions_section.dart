  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<TimeLogBloc, TimeLogState>(
      builder: (context, state) {
        final timeLogs = switch (state) {
          TimeLogLoaded(:final timeLogs) => timeLogs,
          TimeLogLoading(:final timeLogs) => timeLogs,
          TimeLogFailure(:final timeLogs) => timeLogs,
          TimeLogInitial() => const [],
        };
