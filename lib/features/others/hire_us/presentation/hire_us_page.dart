        ...
        slivers: [
          SliverList.list(
            children: [
              ...
              const SizedBox(height: 8),
              Text(
                'Please note, A small to small scale software project typically requires around 100–200 hours of work. Kindly ensure your project scope and budget align before booking a paid consultation.',
                style: TextUtils.paragraph(context),
              ),
              const SizedBox(height: 16),
