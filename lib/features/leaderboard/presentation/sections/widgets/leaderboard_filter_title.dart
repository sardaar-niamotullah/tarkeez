...
import 'package:tarkeez/features/leaderboard/presentation/sections/leaderboard_filter_bottom_sheet.dart';

class LeaderboardFilterTitle extends StatelessWidget {
  const LeaderboardFilterTitle({super.key});
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  Text('Country', style: TextUtils.paragraphSmall(context)),
                ],
              ),
              Row(
                children: [
                  CustomIconButton(
                    ...
                    onTap: () => showModalBottomSheet(
                      ...
                      builder: (BuildContext context) {
                        return const LeaderboardFilterBottomSheet();
                      },
                    ),
                  ),
